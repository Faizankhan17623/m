...
const UserManagement = () => {
 ...
 const ORgId = searchParams.get("id")
  ...
  const pendingCount = orgdata.filter((o) => o.status === 'pending').length
  const approvedCount = orgdata.filter((o) => o.status === 'approved').length
  const rejectedCount = orgdata.filter((o) => o.status === 'rejected' || o.status === 'locked').length
